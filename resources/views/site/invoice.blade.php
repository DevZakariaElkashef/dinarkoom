        ...
        <div style="width: 100%;">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;">{{ $user->phone }}</td>
                </tr>
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;">{{ $user->addition_phone }}</td>
                </tr>
                <tr>
                    <th style="background-color: #f5f5f5; padding: 10px; border-bottom: 1px solid #ddd; font-weight: normal; text-align: left;">Civil ID</th>
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;">{{ $user->civil_id }}</td>
                </tr>
            </table>
        </div>
