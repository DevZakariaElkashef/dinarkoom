...
<nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>{{ __("Update") }}</span></li>
    </ol>
</nav>
@endsection
    ...
    <form action="{{ route("roles.store") }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input name="name" type="text" class="form-control" id="editName" value="{{ $role->name ?? old('name') }}">
                @error('name')
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 mb-3">
                    <div class="form-check">
                      <input class="form-check-input" @if($role->hasPermissionTo($permission->name)) checked @endif  name="options[]" type="checkbox" value="{{ $permission->id }}" id="permission{{ $permission->id }}">
