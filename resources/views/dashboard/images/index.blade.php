                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="" style="with: 100px; overflow: hidden;">
                                        <img class="rounded image-thumbnail" src="{{ Storage::url($image->thumbnail) }}" ></td>
                                    </div>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn @if($image->active) btn-success @else btn-light @endif dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                            @if($image->active)  
                                            {{ __("Active") }}
                                            @else
                                            {{ __("Not_Active") }}
                                        ...
                                        <div class="dropdown-menu">
                                          <a class="dropdown-item" href="{{ route('images.active', $image->id) }}">{{ __('Active') }}</a>
                                          <a class="dropdown-item" href="{{ route('images.deactive', $image->id) }}">{{ __("Not Active") }}</a>
                                        </div>
                                      </div>
                                ...
                                <td class="">
                                    ...
                                    <a href="#" class="delete-images-btn m-1" data-id="{{ $image->id }}" data-toggle="modal" data-target="#deleteImageModal"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
